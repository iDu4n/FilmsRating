package com.itdep.portalbackend.utils;

import com.itdep.portalbackend.model.DatabaseConnection;
import com.itdep.portalbackend.utils.crud.Delete;
import com.itdep.portalbackend.utils.crud.Insert;
import com.itdep.portalbackend.utils.crud.Select;
import com.itdep.portalbackend.utils.crud.Update;
...
public class CRUDutils {
    ...
    public static void selectUserList() {
        try (Statement statement = CONNECTION.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
            ...
            ResultSet table = statement.executeQuery("SELECT id, username FROM public.\"users\"\n ORDER BY id ASC ");
    ...
    public static void insertUser() {
        ...
        try (PreparedStatement statement = CONNECTION.prepareStatement("INSERT INTO public.\"users\"(username, role, email, password) VALUES (?, ?, ?, ?);")) {
    ...
    public static void deleteUser() {
        ...
        try (PreparedStatement statement = CONNECTION.prepareStatement("DELETE FROM public.\"users\"\nWHERE id = ?;")) {
    ...
    public static void updateUser() {
        ...
        try (PreparedStatement statement = CONNECTION.prepareStatement("UPDATE public.\"users\" SET username=?, role=?, email=?, password=? WHERE id=?;")) {
